...
parser.add_argument("--no-default-intervals", dest="no_default_intervals", action="store_true", help="Export only the --additional-intervals code points, not the built-in default set (e.g. an English-only UI font).")
