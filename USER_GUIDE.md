...
The Home screen is the main entry point to the firmware. From here you can navigate to **[Reading Mode](#4-reading-mode)** with the most recently read book, the **[Library](#39-library-screen)** screen, the **[My Files](#33-my-files-screen)** screen, the **[Recent Books](#34-recent-books-screen)** screen, the **[File Transfer](#35-file-transfer-screen)** screen, or **[Settings](#36-settings)**.
...
- **UI Theme**: Set which UI theme to use:
  ...
  - "RoundedRaff" (default) - A rounded theme with additional visual styling
